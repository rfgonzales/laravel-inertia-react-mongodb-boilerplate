...
export default function UpdatePasswordForm({ className = '' }: { className?: string }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="tw-text-lg tw-font-medium tw-text-gray-900 dark:tw-text-gray-100">Update Password</h2>
            ...
            <form onSubmit={updatePassword} className="tw-mt-6 tw-space-y-6">
                ...
                <div className="tw-flex tw-items-center tw-gap-4">
                    ...
                    >
                        <p className="tw-text-sm tw-text-gray-600 dark:tw-text-gray-400">Saved.</p>
                    </Transition>
                </div>
            </form>
        </section>
