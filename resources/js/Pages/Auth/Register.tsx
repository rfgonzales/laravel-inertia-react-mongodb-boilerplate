        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                ...
                <div className="tw-flex tw-items-center tw-justify-end tw-mt-4">
                    <Link
                        href={route('login')}
                        className="tw-underline tw-text-sm tw-text-gray-600 dark:tw-text-gray-400 hover:tw-text-gray-900 dark:hover:tw-text-gray-100 tw-rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                    >
                        Already registered?
                    </Link>
